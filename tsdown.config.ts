/**
 * Standalone tsdown config: node-half library + browser client bundle.
 *
...
export default defineConfig([
  ...
  // closure at mount time (gotcha 1: bundle plugins declare empty deps by
  // design); leave them external so lib/index.js imports resolve at runtime.
  {
    name: ID,
